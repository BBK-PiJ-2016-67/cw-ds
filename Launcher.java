public class Launcher {
	...
	public void launch() {
		...
		teste.expect("It should add an item", linkedList.add("two").getReturnValue(), null);
		teste.expect("It should get an item at index", linkedList.get(0).getReturnValue(), "one");
		...
		teste.expect("It should add an item at index", linkedList.add(1, "three").getReturnValue(), null);
		...
		teste.expect("It should get an item at index", linkedList.get(1).getReturnValue(), "three");
		teste.expect("It should get an item at index", linkedList.get(2).getReturnValue(), "two");
		...
		teste.expect("It should get an item at index", linkedList.get(0).getReturnValue(), "three");
		teste.expect("It should return the size of the list", linkedList.size(), 2);
		/**
		 * Finish tests
		 */
		teste.finish();
